...
class AppModel(nn.Module):
    ...
    def save_weights(self, model_path, iteration):
        out_weights_path = os.path.join(model_path, f"app_model/iteration_{iteration}")
    ...
    def load_weights(self, model_path, iteration=-1):
        ...
        weights_path = os.path.join(model_path, f"app_model/iteration_{loaded_iter}/app.pth")
