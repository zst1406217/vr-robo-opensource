...
class ActionsCfg:
    ...
    joint_pos = mdp.VelocityCommandActionCfg(asset_name="robot", joint_names=[".*"], scale=0.5, use_default_offset=True, velocity_range=[0.5, 0.3, 1.0], 
        policy_dir="/home/yebj/code/IsaacLab/logs/rsl_rl/g1_rough/2025-01-15_20-28-15/model_4999.pt", 
...
@configclass
class UnitreeGo2GSFixG1EnvCfg(UnitreeGo2GSBaseEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class UnitreeGo2GSFixG1EnvCfg_PLAY(UnitreeGo2GSFixG1EnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
