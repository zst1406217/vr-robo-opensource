...
class MySceneCfg(InteractiveSceneCfg):
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        # offset=TiledCameraCfg.OffsetCfg(pos=[0.332+0.01, 0.0+0.015, 0.0578+0.095], rot=[0.5, -0.5, 0.5, -0.5], convention="ros"),
        # data_types=["rgb"],
        data_types=["depth"],
        spawn=sim_utils.PinholeCameraCfg(
        ...
        rigid_objects={
            "object": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    ...
                    # usd_path="./exts/scene_data/bj4_mesh_with_texture/env/env.usd",
        ...
        rigid_objects={
            "cone_red": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    ...
                    # usd_path="./exts/scene_data/bj4_mesh_with_texture/red/red.usd",
                    rigid_props=sim_utils.RigidBodyPropertiesCfg(kinematic_enabled=True, disable_gravity=True),
                    mass_props=sim_utils.MassPropertiesCfg(mass=1.0),
                    collision_props=sim_utils.CollisionPropertiesCfg(collision_enabled=True),
                ),
        ...
        rigid_objects={
            "cone_green": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    ...
                    # usd_path="./exts/scene_data/bj4_mesh_with_texture/green/green.usd",
                    rigid_props=sim_utils.RigidBodyPropertiesCfg(kinematic_enabled=True, disable_gravity=True),
                    mass_props=sim_utils.MassPropertiesCfg(mass=1.0),
                    collision_props=sim_utils.CollisionPropertiesCfg(collision_enabled=True),
                ),
        ...
        rigid_objects={
            "cone_blue": RigidObjectCfg(
                ...
                spawn=sim_utils.UsdFileCfg(
                    ...
                    # usd_path="./exts/scene_data/bj4_mesh_with_texture/blue/blue.usd",
                    rigid_props=sim_utils.RigidBodyPropertiesCfg(kinematic_enabled=True, disable_gravity=True),
                    mass_props=sim_utils.MassPropertiesCfg(mass=1.0),
                    collision_props=sim_utils.CollisionPropertiesCfg(collision_enabled=True),
                ),
...
class ObservationsCfg:
    ...
    class ImageCfg(ObsGroup):
        ...
        # observation terms (order preserved)
        image = ObsTerm(func=mdp.custom_image, params={"data_type":"depth", "normalize":False}, noise=None)
...
class EventCfg:
    ...
    reset_base = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.4, 0.6), "y": (-0.25, -0.25), "yaw": (0, 0)},
...
class TerminationsCfg:
    ...
    bad_orientation = DoneTerm(func=mdp.bad_orientation, params={"limit_angle": 1.0}, time_out=True)
...
@configclass
class UnitreeGo2GSFtEnvCfg(UnitreeGo2GSBaseEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class UnitreeGo2GSFtEnvCfg_PLAY(UnitreeGo2GSFtEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
