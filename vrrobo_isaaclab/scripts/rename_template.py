...
It renames all the occurrences of go2_isaaclab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the go2_isaaclab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "go2_isaaclab", "go2_isaaclab"),
            os.path.join(root_dir_path, "exts", "go2_isaaclab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "go2_isaaclab"), os.path.join(root_dir_path, "exts", new_name))
